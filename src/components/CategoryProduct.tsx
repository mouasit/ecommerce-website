...
export default function CategoryProduct() {
  const responsiveWidth =
    "sm:w-[31.8%] md:w-[28%]  lg:w-[30%] xl:w-[25%]  2xl:w-[15.5rem] ";
  return (
    <section className="mt-[4rem] flex flex-col-reverse gap-16 px-4 lg:flex-row lg:gap-0 2xl:px-0">
      ...
      <div className="w-full">
        ...
        <div className="mt-[4rem] flex flex-col items-center gap-16 sm:flex-row sm:flex-wrap sm:justify-start sm:gap-x-[2.1vw] md:gap-x-[8%] lg:gap-x-[5%] xl:gap-x-[12.5%] 2xl:gap-x-[3.3%]">
          <Product
            name="Xiaomi redmi R..."
            price="1 500"
            imageProduct={redmi}
