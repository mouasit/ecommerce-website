...
export default function Categories() {
  return (
    <section className="mt-[5.7rem] flex flex-wrap justify-center gap-24 px-4 md:flex-row md:flex-wrap md:justify-start md:gap-x-[2.1vw] xl:gap-x-[11vw] 2xl:gap-x-[11.4%] 2xl:px-0">
      <Category
